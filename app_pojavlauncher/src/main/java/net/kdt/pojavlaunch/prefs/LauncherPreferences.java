...
public class LauncherPreferences {
    ...
    public static boolean PREF_DUMP_SHADERS = true;
    public static float PREF_DEADZONE_SCALE = 1f;
    public static boolean PREF_BIG_CORE_AFFINITY = true;
    ...
    public static void loadPreferences(Context ctx) {
        ...
        PREF_DUMP_SHADERS = DEFAULT_PREF.getBoolean("dump_shaders", true);
    ...
    private static boolean isDevicePowerful(Context context) {
        ...
        if (Tools.getTotalDeviceMemory(context) <= 3072) return false;
        DisplayMetrics metrics = context.getResources().getDisplayMetrics();
